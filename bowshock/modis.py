...
if __name__ == "__main__":
	...
	dateList = modisClient( client, product='MOD15A2', band='Lai_1km', lat=52, lon=0 )
	printList( dateList )
	
	
	
	m = modisClient( client, product='MOD15A2', band='Lai_1km', lat=52, lon=-2, startDate=2006100, endDate=2006180 )
